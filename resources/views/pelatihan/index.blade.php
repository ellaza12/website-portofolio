...
<div class="container">
    ...
    <hr>
    <a href="/pelatihan/create" class="btn btn-primary">Tambah Pelatihan</a>
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <h5 class="card-title">{{ $data->nama_pelatihan }}</h5>
                    <p class="card-text">{{ $data->deskripsi }}</p>
                    <a href="/pelatihan/{{ $data->id }}/edit" class="btn btn-warning btn-sm"><i class="bi bi-pencil-fill"></i> Edit</a>
                    <form action="/pelatihan/{{ $data->id }}" method="post" class="d-inline">
                        @method('DELETE')
                        @csrf
